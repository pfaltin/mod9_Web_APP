...
{
    public partial class InitAndRolesSeeding : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<string>(type: "nvarchar(200)", nullable: true),
                    Sku = table.Column<string>(type: "nvarchar(20)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "41112308 - 4603 - 420b - be22 - 3af8a2166be1", "34c0e029-8b33-4b6f-a73a-8455efcd71b8", "Customers", "CUSTOMERS" },
                    { "5109cf15 - d38d - 4fe9 - b385 - 2972b2d2bb20", "ae9cbe85-d20b-4a37-8747-ff5c4271197c", "Administrators", "ADMINISTRATORS" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Cat desc 1", "/1catimg.png", "1.Cat" },
                    { 2, "Cat desc 2", "/2catimg.png", "2.Cat" },
                    { 3, "Cat desc 3", "/3catimg.png", "3.Cat" },
                    { 4, "Cat desc 4", "/4catimg.png", "4.Cat" },
                    { 5, "Cat desc 5", "/5catimg.png", "5.Cat" }
                });
